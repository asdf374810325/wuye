...
<div class="ch-container">
    <div class="row">
                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li class="nav-header">功能</li>
							...
							<li class="active"><a class="ajax-link" href="${pageContext.request.contextPath}/inspection_query.action"><i class="glyphicon glyphicon-info-sign"></i><span> &ensp;保&ensp;安&ensp;保&ensp;洁</span></a>
        ...
        <ul class="breadcrumb">
            ...
            <li>
                <a href="${pageContext.request.contextPath}/inspection_query.action">保安保洁</a>
            </li>
        </ul>
    </div>
    ...
    <c:forEach var="inspection" items="${inspections}" >
        ...
        <td class="center">
            <a class="btn btn-info" href="inspection_get.action?id=${inspection.id}">
                <i class="glyphicon glyphicon-edit icon-white"></i>
                编&ensp;辑
            </a>
            <a class="btn btn-danger" href="" data-href="inspection_delete.action?id=${inspection.id}" data-toggle="modal" data-target="#myModal">
