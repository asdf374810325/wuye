                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li class="nav-header">功能</li>
							...
							<li class="active"><a class="ajax-link" href="${pageContext.request.contextPath}/notice_query.action"><i class="glyphicon glyphicon-envelope"></i><span> &ensp;公&ensp;告&ensp;管&ensp;理</span></a>
        ...
        <div id="content" class="col-lg-10 col-sm-10">
            ...
            <div>
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/notice_query.action">公告管理</a>
                    </li>
                </ul>
            </div>
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                                ...
                                <c:forEach var="notice" items="${notice}">
							        <tr>
                                        ...
                                        <td class="center">
                                            <a class="btn btn-info" href="notice_get.action?id=${notice.id}">
                                                <i class="glyphicon glyphicon-edit icon-white"></i>
                                                编&ensp;辑
                                            </a>
                                            <a class="btn btn-danger" href="#" data-href="notice_delete.action?id=${notice.id}" data-toggle="modal" data-target="#myModal">
