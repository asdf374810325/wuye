                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li class="nav-header">功能</li>
							...
							<li class="active"><a class="ajax-link" href="${pageContext.request.contextPath}/maintain_query.action"><i class="glyphicon glyphicon-wrench"></i><span> &ensp;报&ensp;修&ensp;管&ensp;理</span></a>
        ...
        <div id="content" class="col-lg-10 col-sm-10">
            ...
            <div>
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/maintain_query.action">报修管理</a>
                    </li>
                </ul>
            </div>
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                                ...
                                <c:forEach var="maintain" items="${maintains}" >
									<tr>
                                        ...
                                        <td class="center">
                                            <a class="btn btn-info" href="maintain_get.action?&id=${maintain.id}">
                                                <i class="glyphicon glyphicon-edit icon-white"></i>
                                                编&ensp;辑
                                            </a>
                                            <a class="btn btn-danger" href="#" data-href="maintain_delete.action?&id=${maintain.id}" data-toggle="modal" data-target="#myModal">
