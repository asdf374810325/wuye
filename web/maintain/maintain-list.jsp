                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li class="nav-header">功能</li>
							...
							<li class="active"><a class="ajax-link" href="maintain_query.action"><i class="glyphicon glyphicon-wrench"></i><span> &ensp;报&ensp;修&ensp;管&ensp;理</span></a>
        ...
        <div id="content" class="col-lg-10 col-sm-10">
            ...
            <div>
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="maintainAction_getAllMaintain.action">报修管理</a>
                    </li>
                </ul>
            </div>
