                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                                ...
                                <c:forEach var="admin" items="${admins}" >
                                    <tr>
                                        ...
                                        <td>${admin.memo}</td>
                                        <td class="center">
                                            <a class="btn btn-info" href="admin_get.action?&adminid=${admin.adminid}">
                                                <i class="glyphicon glyphicon-edit icon-white"></i>
                                                编&ensp;辑
                                            </a>
                                            <a class="btn btn-danger" href="#" data-href="admin_delete.action?&adminid=${admin.adminid}" data-toggle="modal" data-target="#myModal">
