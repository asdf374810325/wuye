...
<div class="ch-container">
                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li class="nav-header">功能</li>
							...
							<li class="active"><a class="ajax-link" href="${pageContext.request.contextPath}/admin_query.action"><i class="glyphicon glyphicon-cog"></i><span> &ensp;管&ensp;理&ensp;员&ensp;信&ensp;息</span></a>
							...
							<li><a class="ajax-link" href="${pageContext.request.contextPath}/house_query.action"><i class="glyphicon glyphicon-list-alt"></i><span> &ensp;房&ensp;产&ensp;信&ensp;息</span></a>
                        </li>
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <a href="${pageContext.request.contextPath}/admin_query.action">管理员信息</a>
        </li>
        <li>
            <a href="#">编辑</a>
        </li>
	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                <form action="admin_update.action" method="post" data-toggle="validator">
                    <div class="form-group">
						<div class="input-group col-md-3">
							<label class="control-label" for="name">姓名*</label>
							<input type="text" class="form-control" name="name" value="${admin1.name}" required/>
					...
					<div class="form-group">
						<div class="input-group col-md-1">
							...
							<input type="number" class="form-control" name="age" value="${admin1.age}" required/>
							<span class="help-block with-errors"></span>
						</div>
					</div>
					<div class="form-group">
						<div class="input-group col-md-3">
							...
							<input type="text" class="form-control" name="tel" value="${admin1.tel}"/>
						</div>
					</div>
					<div class="form-group">
						<div class="input-group col-md-3">
							<label class="control-label" for="phone">手机</label>
							<input type="text" class="form-control" name="phone" value="${admin1.phone}"/>
						</div>
					</div>
					<div class="form-group">
						<div class="input-group col-md-4">
							<label class="control-label" for="addr">地址*</label>
							<input type="text" class="form-control" name="addr" value="${admin1.addr}" required/>
							<span class="help-block with-errors"></span>
						</div>
					</div>
					<div class="form-group">
						<div class="input-group col-md-4">
							...
							<input type="text" class="form-control" name="memo" value="${admin1.memo}"/>
						</div>
					</div>
					<input type="hidden" name="id"  value="${admin1.adminid}">
